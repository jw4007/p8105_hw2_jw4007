...
The total weight of trash collected by Professor Trash Wheel is `r sum(pull(prof_trash, weight_tons))`.
The total number of sports balls collected by Mr. Trash Wheel in 2020 is `r sum(pull(mr_trash, sports_balls))`.

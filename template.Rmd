...
```
The "Mr. Trash Wheel" dataset has `r nrow(mr_trash)` observations with the following variables: `r colnames(mr_trash)`.The total number of sports balls collected by Mr. Trash Wheel in 2020 is `r sum(pull(mr_trash, sports_balls))`.
